package day01.miscellaneous;

public class AddDogPackage {
    // Attributes
    private boolean hasDots;
    private String color;

    // Constructor
    public AddDogPackage(boolean hasDots, String color) {
    ...
    public static void main(String[] args) {
        ...
        AddDogPackage dog1 = new AddDogPackage(true, "purple");
        AddDogPackage dog2 = new AddDogPackage(true, "blue");
